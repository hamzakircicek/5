...
class _mesajSayfaState extends State<mesajSayfa> {
      ...
      body: ListView(
        children:[ Column(
          children:[
            ...
            stream: _firestore.collection('mesaj').doc(widget.karsiUid).collection('mesajIci').where("karsiUid", isEqualTo: _auth.currentUser.uid ).snapshots(),
            ...
            Row(
              ...
              children: [
                ...
                IconButton(icon: Icon(Icons.send), onPressed: (){
                     ...
                     mesajj(_auth.currentUser.email,ben, _auth.currentUser.uid, widget.karsiUid, txt.text,widget.kullanici);
                     setState(() {
  ...
  void mesajj(String gonderenEmail,bool onayDurumu,String uid,String karsiUid,String icerik,String kullanici) async{
    try{
      ...
      await _firestore.collection('mesaj').doc(widget.karsiUid).collection('mesajIci').doc().set(aktar, SetOptions(merge: true));
